...
import FromPier from "./FromPier";
import ToPier from "./ToPier";
...
const PierSearchBox = () => {
  ...
  const [selectedToPierId, setSelectedToPierId] = useState<number | null>(null);
